...
<table width="90%" align="center" border>
	<form method = "post" action = "basket_verify_enroll.jsp">
	<br>
	<tr><th>과목번호</th><th>분반</th><th>과목명</th><th>시간</th><th>장소</th><th>학점</th><th>신청</th><th>해제</th></tr>
	<% 
	...
	CallableStatement cstmt = conn.prepareCall("{call ShowBasket(?,?)}");
	...
	<td align="center"><input type = "checkbox" name = "delete" value = "<%=c_id%>,<%=c_id_no%>"></td>
	</tr>
	<%
	}
	cstmt.close();
