...
<body>
	...
	<br>
	<tr><th>과목번호</th><th>분반</th><th>과목명</th><th>시간</th><th>장소</th><th>학점</th><th>신청취소</th></tr>
	...
	<% 
		...
		int sumN = cstmt.getInt(4);
		int sumU = cstmt.getInt(5);
	...
	<td align="center"><a href="delete_verify.jsp?c_id=<%= c_id %>&c_id_no=<%=c_id_no %>"><span style="color:red">신청취소</span></a></td>
	</tr>
	...
	<table width="75%" align="center" border>
	<tr><th>총 과목 수</th><th>총 학점</th></tr>
	<tr>
	<td align="center"><span style="color:gray"><%=sumN %></span></td>
	<td align="center"><span style="color:gray"><%=sumU %></span></td>
	</table>
